...
\begin{exercise}{Kdaj nevronska mreža premaga linearni model?}
Sestavi vsaj 5-dimenzionalni klasifikacijski problem z izrazito nelinearno odločitveno mejo, na istih podatkih nauči linearni model (logistična regresija) in nevronsko mrežo z eno skrito plastjo ter primerjaj njuno točnost. 
\end{exercise}

\begin{exercise}{Kdaj nevronska mreža premaga linearni model pri regresiji?}
Sestavi regresijski problem z vsaj petimi vhodnimi značilkami in izrazito nelinearno povezavo med vhodom in razredom. Na istih podatkih nauči linearni regresijski model in nevronsko mrežo z eno skrito plastjo ter primerjaj njuno napovedno točnost in prileganje napovedi učnim podatkom.
\end{exercise}
...
\begin{exercise}{Kaj se nauči skrita plast?}
Sestavi regresijski problem, pri katerem nevronska mreža z dvema skritima plastema doseže dobro napovedno točnost z bistveno manj parametri kot mreža z eno samo skrito plastjo, ter primerjaj, kako široka mora postati enoplastna mreža, da doseže primerljivo napako.
\end{exercise}
...
\begin{exercise}{Kaj pove gradient vhoda?}
Za posamezne primere izračunaj gradient napovedi glede na vhodne značilke, ga uporabi kot lokalno mero pomembnosti značilk ter primerjaj razlage za primere iz različnih delov vhodnega prostora in posebej za primere blizu odločitvene meje.
\end{exercise}
