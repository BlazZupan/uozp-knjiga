...
Izberi poljuben prosto dostopen podatkovni nabor. Ročno izberi 10--20 primerov, ki se ti zdijo zanimivi, in jih obravnavaj kot gručo. Nato uporabi postopke iz tega poglavja za \emph{razlago} te skupine: rangiranje atributov (zvezne značilke), analizo kategoričnih spremenljivk (npr.\ \(\chi^2\)-test) in obogatenost skupin atributov. Pri interpretaciji preveri, ali je rangiranje značilk smiselno in ali so obogatene skupine značilk skladne s tvojim domenskim znanjem. 
\end{exercise}
...
\begin{exercise}{Kako stabilne so gruče?}
Isto podatkovno množico večkrat rahlo spremeni z vzorčenjem primerov ali dodajanjem majhnega šuma, vsakič ponovno izvedi gručenje in primerjaj, kateri pari primerov ostajajo skupaj ter katere gruče se pogosto razcepijo ali združijo.
\end{exercise}
...
\begin{exercise}{Kdaj k-means vidi gruče, ki jih ni?}
Generiraj podatke v obliki obroča, podkve ali dveh podolgovatih skupin, uporabi metodo voditeljev za več vrednosti parametra $k$ ter razloži, kako predpostavka o približno kroglastih gručah vpliva na dobljeno razbitje.
\end{exercise}
...
\begin{exercise}{Kaj se zgodi z osamelci?}
V podatkovno množico postopoma dodajaj vedno bolj oddaljene osamelce ter primerjaj, kako se nanje odzovejo metoda voditeljev, DBSCAN in silhueta, posebej pa opazuj, ali lahko že nekaj skrajnih primerov bistveno spremeni položaj voditeljev ali oceno kakovosti gručenja.
\end{exercise}
