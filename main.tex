...
\par To delo je izdano pod licenco Priznanje avtorstva-Nekomercialno-Deljenje pod enakimi pogoji 4.0 Mednarodna (CC BY-NC-ND 4.0).
...
Besedilo namesto uvodnika. 

\mainmatter

%\part{Part Name}
\input{010-racunski-graf}
\input{020-strojno-odvajanje}
\input{030-linreg}
\input{040-regularizacija}
\input{050-pca}
\input{060-vlozitve}
\input{080-glm}
